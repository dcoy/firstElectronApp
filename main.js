...
// Keep a global reference of the window object, if this is not done,
// the window will be closed automatically when the JS object is
// garbage collected.
...
app.on('window-all-closed', () => {
  // On macOS, it is commong for applications and their menu bar
...
// Put the applications main processing code here.
// Also, the code can be placed into separate files
// and required here.
